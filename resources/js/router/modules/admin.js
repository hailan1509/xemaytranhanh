...
const adminRoutes = {
  ...
  children: [
    /** User managements */
    {
      ...
      name: 'UserProfile',
      meta: { title: 'userProfile', noCache: true, permissions: ['view menu administrator'] },
      hidden: true,
    },
    {
      path: 'users',
      ...
      name: 'UserList',
      meta: { title: 'users', icon: 'user', permissions: ['view menu administrator'] },
    },
    /** Role and permission */
    {
      path: 'roles',
      ...
      name: 'RoleList',
      meta: { title: 'rolePermission', icon: 'role', permissions: ['view menu administrator'] },
    },
    // {
